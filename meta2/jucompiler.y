...
Program: CLASS ID LBRACE ProgramRep RBRACE 
                {
                tree = create_node("Program","NULL");
                node* temp= create_node("Id",$2);
                add_next(temp,$4);
                add_son(tree,temp);
                $$ = tree;
                }
...
MethodDecl: PUBLIC STATIC MethodHeader MethodBody 
                {
                node* temp; temp = create_node("MethodDecl","NULL");
                add_son(temp,$3);
                add_son(temp,$4);
                /*printf("%s\n",temp->son->name);*/
                $$=temp;
...
FieldDecl: PUBLIC STATIC Type ID FieldDeclRep SEMICOLON 
                {
                node* temp = create_node("FieldDecl","NULL");
                node* temp1 = create_node("Id",$4);
                add_son(temp,$3); 
                add_son(temp,temp1);
                add_next(temp,$5);
                $$ = temp; 
                ...
                while(temp3->next!=NULL){
                        temp3=temp3->next;
                        node* tipo = create_node(temp4,"NULL");
...
MethodHeader: {$$ = NULL;}
        ...
        | Type ID LPAR FormalParams RPAR 
                {
                node* temp = create_node("MethodHeader","NULL");
                node* temp1 = create_node("Id",$2);
                node* temp2 = create_node("MethodParams","NULL");
                add_son(temp2,$4);
                add_son(temp,$1);
                add_son(temp,temp1);
                add_son(temp,temp2);
        ...
        | VOID ID LPAR FormalParams RPAR 
                {
                node* temp = create_node("MethodHeader","NULL");
                node* temp1 = create_node("Void","NULL");
                node* temp2 = create_node("Id",$2);
                node* temp3 = create_node("MethodParams","NULL");
                add_son(temp3,$4);
                add_son(temp,temp1);
                add_son(temp,temp2);
                add_son(temp,temp3);
...
FormalParams: {$$ = NULL;}
        ...
        | Type ID FormalParamsRep 
                {
                node* temp = create_node("ParamDecl","NULL");
                node* temp1 = create_node("Id",$2);
                add_son(temp,$1);
                add_son(temp,temp1);
                add_next(temp,$3);
        ...
        | STR LSQ RSQ ID 
                {
                node* temp = create_node("ParamDecl","NULL");
                node* temp1 = create_node("StringArray","NULL");
                node* temp2 = create_node("Id",$4);
...
MethodBody: LBRACE MethodBodyRep RBRACE 
                {
                node* temp = create_node("MethodBody","NULL");
                add_son(temp,$2);
                $$ = temp;
                }
...
VarDecl: Type ID VarDeclRep SEMICOLON 
                {
                node* temp = create_node("VarDecl","NULL");
                node* temp1 = create_node("Id",$2);
                add_son(temp,$1);
                add_son(temp,temp1);
                add_next(temp,$3);
...
Statement: LBRACE StatementRep RBRACE 
                {
                if (is_block($2) == true){
                        node* temp = create_node("Block","NULL");
                        add_son(temp,$2);
                        $$=temp;
                        }
                else $$ = $2;
         ...
         | IF LPAR Aux RPAR Statement 
                {
                node* temp = create_node("If","NULL");
                add_son(temp,$3);
                $$ = temp;
                if($5 == NULL || is_block($5) == true){
                        node* temp1 = create_node("Block","NULL");
                        add_son(temp1,$5);
                        add_son(temp,temp1);
                        }
                else add_son($$,$5);
                node* temp2 = create_node("Block","NULL");
                add_son($$,temp2);
                }
         ...
         | WHILE LPAR Aux RPAR Statement 
                {
                node* temp = create_node("While","NULL");
                add_son(temp,$3);
                $$=temp;
                if($5 == NULL || is_block($5) == true){
                        node* temp1 = create_node("Block","NULL");
         ...
         | RETURN Aux SEMICOLON 
                {
                node* temp = create_node("Return","NULL");
                add_son(temp,$2);
                $$ = temp;
                }
         ...
         | PRINT LPAR Aux RPAR SEMICOLON 
                {
                node* temp = create_node("Print","NULL");
                add_son(temp,$3);
                $$ = temp;
                }
         ...
         | PRINT LPAR STRLIT RPAR SEMICOLON 
                {
                node* temp = create_node("Print","NULL");
                node* temp1 = create_node("StrLit",$3);
                add_son(temp,temp1);
                $$ = temp;
                }
...
Statementaux: ParseArgs {$$ = $1;}
        ...
        | ID ASSIGN Aux 
                {
                node* temp1 = create_node("Assign","NULL");
                node* temp2 = create_node("Id",$1);
                add_son(temp1,temp2);
                add_son(temp1,$3);
                $$=temp1;
                }
...
MethodInvocation: ID LPAR RPAR 
                {
                node* temp1 = create_node("Call","NULL");
                node* temp2 = create_node("Id",$1);
                add_son(temp1,temp2);
                $$=temp1;
                }
...
ParseArgs: PARSEINT LPAR ID LSQ Aux RSQ RPAR 
                {
                node* temp = create_node("ParseArgs","NULL");
                node* temp1 = create_node("Id",$3);
                add_son(temp,temp1);
                add_son(temp,$5);
                $$ = temp;
...
Expr: Expr PLUS Expr {node* temp = create_node("Add","NULL"); add_son(temp,$1); add_son(temp,$3); $$=temp;}
     ...
     |ID DOTLENGTH 
                {
                node* temp = create_node("Id",$1);
                node* temp1 = create_node("Length","NULL");
                add_son(temp1,temp);
                $$=temp1;
                }
...
void yyerror (char *s){
        // Como STRLIT é um estado do lex o yytext apenas contem a aspa de fechar a string,
        // por isso tem de se usar yylval em vez de yytext
        if (yychar == STRLIT){
